...
The repository-level `../../AGENTS.md` is authoritative. In particular: keep commerce routes
server-rendered by default, keep client boundaries small, and never import WebAR or Three.js into
the base storefront bundle.
